...
[CyIME 0.1.9 合并键拼音与 Shift 手势](docs/cyime-0.1.9.md) · [CyIME 0.1.8 统一间距与手写确认](docs/cyime-0.1.8.md) · [0.1.7 拼音、语音标点与动画修复](docs/cyime-0.1.7.md) · [CyIME 0.1.6 语音、手写与按键效果](docs/cyime-0.1.6.md) · [0.1.5 键盘交互修复](docs/cyime-0.1.5.md)
...
The repository is now `Cyletix/CyIME`; former `Cyletix/Xime` URLs redirect to it. Existing releases may still carry the former name. New builds use `CyIME-0.1.9-<abi>.apk`. The application ID and signing configuration remain compatible with the existing fork.
